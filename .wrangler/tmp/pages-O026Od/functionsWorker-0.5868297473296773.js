...
async function onRequest(context2) {
  const baseUrl = context2.env.LION_LINK_API_URL;
  ...
  headers.delete("host");
  try {
    const response = await fetch(target, { method: context2.request.method, headers, body: ["GET", "HEAD"].includes(context2.request.method) ? void 0 : context2.request.body });
...
// ../.wrangler/tmp/pages-O026Od/functionsRoutes-0.8543375951651718.mjs
var routes = [
  {
    routePath: "/api/:path*",
    mountPath: "/api",
